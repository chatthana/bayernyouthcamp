    ...
    <div class="team-information">
      ...
      <div class="registration-information">
        ...
        <div id="team-member-render-zone">
          ...
          <?php endforeach; ?>
          <div id="submit-zone" class="row" style="text-align:center; margin-top:35px;">
            <?php echo Html::a('ยืนยันการสมัคร', Yii::$app->urlManager->createUrl(['site/confirm', 'confirmtype'=>'team']), ['class'=>'button blue', 'id' => 'team-confirm-button']); ?>
